...
bool load_data(size_t limit){
  ...
  mysqlD.database = "1200db";	// the databse to pick
  ...
  if(limit == 0){
    sprintf(qry,"select nom_fr,prenom_fr from abonne_ft_v3");
  }else{
    sprintf(qry,"select nom_fr,prenom_fr from abonne_ft_v3 limit 0,%d",limit);
  }
